...
namespace Lista
{
    public class Lista<T> : IListCollection<T>, IEnumerable
    {
        ...
        //implementacja metody string ToString() -> wywołanie Console.Write("obiekt typu Lista<T>")
        ...
        //implementacja wlasciwosci Length
        public int Length
        {
            get
            {
        ...
        public bool IsEmpty() => head == null;  //implementacja metody z interfejsu IListCollection<T>
        ...
        public void Remove(T value) //implementacja metody z interfejsu IListCollection<T>
        {
            Node? current = head;
            Node? previous = null;
            while (current != null)
        ...
        public void Show()  //implementacja metody z interfejsu IListCollection<T>
        {
            Node? current = head;
            while (current != null)
            {
        ...
        //implementacja metod z IEnumerable i IEnumarator;
